...
export const HF_FLOORS: FloorNumber[] = [1, 2, 3];

// ----------------------
// Room generation helpers
// ----------------------
export function hfAllRoomsForFloor(floor: FloorNumber): number[] {
  const base = floor * 100;
  const count = floor === 1 ? 24 : 23;
  return Array.from({ length: count }, (_, i) => base + i + 1);
}

export function hfTopLeftRooms(floor: FloorNumber): number[] {
  const base = floor * 100;
  return floor === 1
...
export function hfMiddleLeftRooms(floor: FloorNumber): number[] {
  const base = floor * 100;
  return floor > 1
...
export function hfBottomLeftRooms(floor: FloorNumber): number[] {
  const base = floor * 100;
  return floor === 1
...
export function hfTopRightRooms(floor: FloorNumber): number[] {
  const base = floor * 100;
  return floor === 1
...
export function hfBottomRightRooms(floor: FloorNumber): number[] {
  const base = floor * 100;
  return floor === 1
...
// Booking & bed rules
// ----------------------
export function hfBookedRoomsForFloor(_floor: FloorNumber): number[] {
...
export function getBedsForRoom(room: number): number {
...
// Layout config
// ----------------------
export function getFloorConfig(floor: 1 | 2 | 3) {
  if (floor === 1) {
    return {
...
// Totals
// ----------------------
export function getTotalRoomsForFloor(floor: 1 | 2 | 3): number {
  return hfAllRoomsForFloor(floor).length;
}

export function getTotalBedsForFloor(floor: 1 | 2 | 3): number {
