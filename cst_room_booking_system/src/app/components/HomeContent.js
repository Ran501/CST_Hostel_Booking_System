    ...
    <main className="min-h-screen w-full bg-slate-50">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="relative">
              ...
              {/* TODO: Display correct user avatar after authentication.
              If gender === "male", show man2.png
          If gender === "female", show woman2.png */}
      ...
      <div className="py-2 divide-y divide-gray-100">
        <button
          onClick={() => {
            setShowProfileMenu(false);
            // Navigate to help page - you'll need to add routing
            router.push('/help');
          }}
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
    <div className="relative w-full max-w-sm sm:max-w-md rounded-2xl bg-white shadow-2xl">
      ...
      <div className="px-6 pt-14 pb-6">
        ...
        {/* Buttons - Match His Design */}
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
          <button
            onClick={handleLogout}
            className="inline-flex w-full sm:w-auto h-10 items-center justify-center rounded-md bg-cstcolor px-5 text-sm font-medium text-white shadow-sm hover:bg-cstcolor-700 focus:outline-none focus:ring-2 focus:ring-cstcolor2 cursor-pointer"
          >
            Yes
          </button>
          <button
            onClick={() => setShowLogoutConfirm(false)}
            className="inline-flex w-full sm:w-auto h-10 items-center justify-center rounded-md border border-cstcolor bg-white px-5 text-sm font-medium text-cstcolor hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-600/30 cursor-pointer"
          >
            No
          </button>
        </div>
